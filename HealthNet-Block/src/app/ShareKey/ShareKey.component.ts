...
export class ShareKeyComponent implements OnInit {
  ...
  encryptedPatientKeyDoctorPublic = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    ...
    this.myForm.setValue({
      'patient': null,
      'doctor': null,
      'encryptedPatientKeyDoctorPublic': null,
      'transactionId': null,
      'timestamp': null
    });

    return this.serviceShareKey.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceShareKey.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceShareKey.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceShareKey.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
      ...
      if (result.encryptedPatientKeyDoctorPublic) {
        formObject.encryptedPatientKeyDoctorPublic = result.encryptedPatientKeyDoctorPublic;
      } else {
        formObject.encryptedPatientKeyDoctorPublic = null;
      }
